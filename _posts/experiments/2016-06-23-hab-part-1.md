...
The rest of this post covers my build process and how I selected the launch site. A <a href="{{ site.baseurl }}{% link _posts/experiments/2016-06-24-hab-part-2.md %}">second post</a> details the actual launch and recovery.  
## III. Research phase
...
Check out my <a href="{{ site.baseurl }}{% link _posts/experiments/2016-06-24-hab-part-2.md %}">second post</a> for the story of the launch and recovery.